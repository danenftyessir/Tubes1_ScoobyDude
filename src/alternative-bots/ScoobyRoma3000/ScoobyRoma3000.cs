...
public class ScoobyRoma3000 : Bot
{
    ...
    {
        new ScoobyRoma3000().Start();
    }
    
    // Ambil konfigurasi dari file JSON (misalnya ScoobyRoma3000.json)
    public ScoobyRoma3000() : base(BotInfo.FromFile("ScoobyRoma3000.json")) {}
